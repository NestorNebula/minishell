...
# SRC = $(SRC_DIR)/dll.c $(SRC_DIR)/dll-helpers.c $(SRC_DIR)/command.c \
	  ...
	  $(SRC_DIR)/exec/exec-command.c $(SRC_DIR)/exec/handle-command.c \
	  $(SRC_DIR)/exec/parent.c $(SRC_DIR)/exec/post-exec.c \
	  $(SRC_DIR)/exec/prepare-command.c $(SRC_DIR)/exec/prepare-files.c \
	  $(SRC_DIR)/exec/wait.c $(SRC_DIR)/exec/end-exec.c \
	  $(SRC_DIR)/exec/exec-line.c $(SRC_DIR)/exec/exec.c \
	  $(SRC_DIR)/builtins.c \
	  ...
	  $(SRC_DIR)/expansion.c $(SRC_DIR)/expansion_utils.c $(SRC_DIR)/parser.c \
	  main.c
